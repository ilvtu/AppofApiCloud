...
function ajaxPhotoRequest(url, method, imgurl, callBack) {
    var common_url = 'http://d.apicloud.com/mcm/api';
    var appId = 'A6930868994492';
    var key = '0EB4D996-A15B-5CEC-2BD1-58E32A59450D';
    var now = Date.now();
	...
	api.ajax({
	    ...
	    returnAll:false,	
	    headers:{
		        'X-APICloud-AppId': 'A6930868994492',
